      ...
      cover={
        <>
          ...
          {item.__typename === "Mirror" ? (
            item.mirrorOf.metadata.mainContentFocus === "VIDEO"
          ) : item.metadata.mainContentFocus === "VIDEO" ? (
            <i
              className="iconfont icon-bofang cursor-pointer text-[40px] opacity-70
          ...
          <div className="cursor-pointer leading-[2px] text-[14px] flex flex-row items-center">
            <i
              className={`iconfont icon-${
                favouriteStatus ? "heart-fill text-[#ff2442]" : "heart"
              } mr-[5px]`}
            />
