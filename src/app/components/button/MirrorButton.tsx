...
import { Comment, Post, ProfileOwnedByMe, useCreateMirror } from '@lens-protocol/react-web';
...
export default function MirrorButton({ publication, publisher }: MirrorButtonProps) {
